...
check_token() {
  echo -e "                                                       "
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "${BLUE}[+]               LICENSE DRAXO CLIPS            [+]${NC}"
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "                                                       "
  ...
  if [ "$USER_TOKEN" = "sanoofc" ]; then
    ...
    echo -e "${GREEN}Token Salah! Beli Kode Token Di DraxoClips${NC}"
    echo -e "${YELLOW}TELEGRAM : @DraxoKe2${NC}"
    echo -e "${YELLOW}WHATSAPP : +6289605983169${NC}"
    echo -e "${YELLOW}HARGA TOKEN : 10K FREE UPDATE JIKA ADA TOKEN BARU${NC}"
    echo -e "${YELLOW}© DRAXO CLIPS${NC}"
    exit 1
  fi
  clear
}
...
while true; do
  ...
  echo -e "${RED}ggg:     gg.     -   ,ggg       • Telegram : @DraxoKe2      ${NC}"
